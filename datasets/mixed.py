...
def get_mixed_datasets(size:int,gradual:bool=False,seed:int=23) -> dict:
    ...
    for i in range(0,2*n,2):
        datasets[f'mixed_{drift}_' + name + '_'+str(i)] = (create_mixed_dataset(size, seed+i,gradual), size)
