...
#evaluate the dataset on STEPD with the BOLE classifier and then write the results in a csv-file  
for i in range(1,250,50):
    ...
    write_results_to_csv(f'results/{generator}/{variant}/{generator}_{variant}_bole_stepd_{i}.csv', bole) 
