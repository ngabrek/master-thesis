...
#evaluate the abrupt datasets on ADWIN with the BOLE classifier without detection and then write the results in a csv-file  
i = 51
...
write_results_to_csv(f'results/{generator}/{size_name}/{generator}_{size_name}_abrupt_bole_adwin_{i}.csv', abrupt_bole) 
