...
#evaluate the gradual datasets on STEPD with the BOLE classifier but BOCD and KSWIN and then write the results in a csv-file  
i = 151
...
write_results_to_csv(f'results/{generator}/{size_name}/{generator}_{size_name}_gradual_bole_stepd{i}.csv', gradual_bole)  
