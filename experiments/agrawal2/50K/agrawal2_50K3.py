...
#evaluate the gradual datasets on the naive baselines and all combinations with the Hoeffding tree classifier and then write the results in a csv-file
gradual_ht = evaluation(gradual,nominal_attributes=nominal_features,nb=False,bole=False)
