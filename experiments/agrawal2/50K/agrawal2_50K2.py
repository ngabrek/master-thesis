...
#evaluate the abrupt datasets on the naive baselines and all combinations with the Hoeffding tree classifier and then write the results in a csv-file  
abrupt_ht = evaluation(abrupt,nominal_attributes=nominal_features,nb=False,bole=False)
