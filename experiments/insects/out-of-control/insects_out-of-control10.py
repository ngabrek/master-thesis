...
#evaluate the datasets on PH with the BOLE classifier and then write the results in a csv-file  
for i in range(1,250,50):
    bole = evaluation(dataset,nominal_attributes=nominal_features,nb=False,majclass=False,nochange=False,ht=False,bocd=False,basic=False,adwin=False,cusum=False,
                               eddm=False,ddm=False,ecdd=False,gma=False,hddma=False,kswin=False,hddmw=False,rddm=False,stepd=False,seed=i)
