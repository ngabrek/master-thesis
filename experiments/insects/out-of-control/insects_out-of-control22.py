...
#evaluate the datasets on BOCD with the BOLE classifier and then write the results in a csv-file  
i = 201
bole = evaluation(dataset,nominal_attributes=nominal_features,nb=False,majclass=False,nochange=False,ht=False,kswin=False,basic=False,adwin=False,cusum=False,
