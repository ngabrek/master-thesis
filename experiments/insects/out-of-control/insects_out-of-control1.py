...
#evaluate the datasets on the BOLE classifier and then write the results in a csv-file  
for i in range(1,250,50):
    bole = evaluation(dataset,nominal_attributes=nominal_features,nb=False,majclass=False,nochange=False,ht=False,bocd=False,adwin=False,cusum=False,ddm=False,
