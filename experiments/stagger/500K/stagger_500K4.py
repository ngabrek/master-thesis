...
gradual_nb = evaluation(gradual,nominal_attributes=nominal_features,majclass=False,nochange=False,ht=False,bole=False,adwin=False,cusum=False,ddm=False,ecdd=False,eddm=False,gma=False,hddma=False,
                       hddmw=False,kswin=False,ph=False,rddm=False,stepd=False,basic=False)
